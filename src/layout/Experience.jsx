      ...
      <Container>
        ...
        <div className="mb-10 text-center sm:mb-12">
          ...
          <p className="mx-auto mt-3 max-w-2xl px-4 text-sm leading-6 text-gray-600 sm:text-base">
            A professional journey of over 17 years in Industrial Engineering,
            Production Management, and Garment Manufacturing Operations.
          </p>
        </div>
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 md:grid-cols-2">
          {experiences.map((experience, index) => (
            ...
            >
              {/* Date */}
              <div className="mb-5">
                <span className="inline-block rounded-full bg-black px-4 py-2 text-xs font-semibold text-white">
                  {experience.duration}
                </span>
              </div>
              ...
              <div className="mt-5">
                ...
                <ul className="space-y-2.5">
                  {experience.responsibilities.map((item, i) => (
                    ...
                    >
                      <span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-black"></span>
